...
const endpoints = [
  ...
  [
    ...
    "Users",
    "Wishlistga qo'shish yoki o'chirish",
    true,
  ],
  ...
  [
    ...
    "/users/preferences",
    "Users",
    "Til va mintaqa sozlamalarini yangilash",
    true,
  ],
  ...
  [
    ...
    "/click/create-order",
    "Click",
    "Click orqali buyurtma yaratish",
    true,
  ],
  [
    "get",
    "/click/order-status/{orderId}",
    "Click",
    "Click buyurtma holati",
    true,
  ],
  ...
  [
    ...
    "Admin Products",
    "Kitob zaxirasini yangilash",
    true,
  ],
  [
    "patch",
    "/admin/products/{id}/toggle-top",
    "Admin Products",
    "Top holatini almashtirish",
    true,
  ],
  [
    "delete",
  ...
  [
    ...
    "Admin Categories",
    "Kategoriya holatini almashtirish",
    true,
  ],
  [
    "patch",
    "/admin/categories/{id}/toggle-featured",
    "Admin Categories",
    "Featured holatini almashtirish",
    true,
  ],
  [
    "post",
  ...
  [
    "delete",
    "/admin/categories/{categoryId}/sub/{subId}",
    "Admin Categories",
  ...
  [
    ...
    "Admin Subscriptions",
    "Obuna holatini almashtirish",
    true,
  ],
  [
    "post",
    "/admin/subscriptions/update-order",
    "Admin Subscriptions",
    "Obuna tartibini yangilash",
    true,
  ],
];
